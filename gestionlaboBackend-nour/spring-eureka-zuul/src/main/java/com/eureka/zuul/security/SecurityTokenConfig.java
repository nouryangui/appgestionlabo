...
public class SecurityTokenConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
				...
				// required here)
				.antMatchers(HttpMethod.POST, "/member-service/api/members/publications/**").hasAnyAuthority("user")
				.antMatchers(HttpMethod.POST, "/member-service/api/members/tools/**").hasAnyAuthority("user")
				.antMatchers(HttpMethod.POST, "/member-service/api/members/events/**").hasAnyAuthority("user")
