...
import { MembertoolformComponent } from 'app/member-list/membertoolform/membertoolform.component';
...
export class ToolListComponent implements OnInit {
  ...
  onAddMemberToTool(idTool:number)
  {const dialogRef = this.matDialog.open(MembertoolformComponent, {
    disableClose: false,
    width: '30%',
    data: { toolId: idTool }
  });
