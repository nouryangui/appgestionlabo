...
import { TeacherstudentsComponent } from 'app/teacherstudents/teacherstudents.component';
...
export class MemberListComponent implements OnInit {
  ...
  displayedColumns: string[] = ['id', 'Cin', "FirstName","LastName", 'Date Of Birth', 'Email', 'CV','Type'];
  totalPages: number;
  currentPage: number;
  ...
  onDetailStudents(idMember: number): void {
    const dialogRef = this.matDialog.open(TeacherstudentsComponent, {
      disableClose: false,
      width: '30%',
      data: { memberId: idMember }
    });
